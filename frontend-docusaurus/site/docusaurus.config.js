...
const config = {
  ...
  tagline: 'Master the future of embodied artificial intelligence',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: '/docs/module-01/chapter-01-introduction',
            label: 'Get Started',
            position: 'left',
          },
        ],
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/module-02/chapter-06-gazebo-intro',
              },
              {
                label: 'Module 3: NVIDIA Isaac',
                to: '/docs/module-03/chapter-08-isaac-sdk',
              },
              {
                label: 'Module 4: Humanoid Robotics',
                to: '/docs/module-04/chapter-11-humanoid-dev',
              },
            ],
          },
          {
